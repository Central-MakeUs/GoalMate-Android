...
class CalendarTest {
    ...
    fun test02() {
        val startDate = LocalDate.of(2025, 2, 10)
        val endDate = LocalDate.of(2025, 3, 14)
        val target = LocalDate.of(2025, 2, 12)
        val results = generateWeeklyCalendar(startDate, endDate, target)
        ...
        println("updated!")
        val result2 = updateProgressForWeeks(results.weeklyData, weeklyProgress1.progressList)
        result2.forEach {
            println(it)
            println()
        }
...
val weeklyProgress1 = WeeklyProgressDto(
    progressList = listOf(
        ProgressDto("2025-02-09", "SUNDAY", 3, 2, true),
        ProgressDto("2025-02-10", "MONDAY", 5, 3, true),
        ProgressDto("2025-02-11", "TUESDAY", 2, 1, true),
        ProgressDto("2025-02-12", "WEDNESDAY", 4, 3, true),
        ProgressDto("2025-02-13", "THURSDAY", 3, 2, true),
        ProgressDto("2025-02-14", "FRIDAY", 4, 3, true),
        ProgressDto("2025-02-15", "SATURDAY", 2, 1, true),
    ),
    hasLastWeek = true,
    hasNextWeek = true,
)
