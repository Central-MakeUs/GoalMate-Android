...
fun updateProgressForWeeks(
    ...
    if (weekIndex != -1) {
        val shouldLoadPrevious = updatedCalendar[weekIndex].shouldLoadPrevious
        updatedCalendar[weekIndex] = Week(dailyProgresses = updatedWeekProgress, shouldLoadPrevious = shouldLoadPrevious)
